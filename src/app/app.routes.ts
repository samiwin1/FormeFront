...
import { PartnerFeedbacksComponent } from './features/partner/feedbacks/partner-feedbacks.component';
...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'my-feedbacks', component: PartnerFeedbacksComponent, canActivate: [authGuard] },
      { path: 'partner-feedback', component: PartnerFeedbacksComponent }
    ],
  },
  {
    path: 'admin',
